...
// node_modules/.pnpm/simulationjs@1.0.0/node_modules/simulationjs/dist/simulation.js
var fps;
var currentMousePos;
...
var _setRotation3, setRotation_fn3, _getInitialStartAndMag, getInitialStartAndMag_fn, _getProcessedStartAndMag, getProcessedStartAndMag_fn, _updateDimentions, updateDimentions_fn, _checkEvents2, checkEvents_fn2;
var _Square = class extends SimulationElement {
  constructor(pos, width, height, color, offsetPoint = new Point(0, 0), rotation2 = 0) {
    ...
    __privateAdd(this, _updateDimentions);
  ...
  draw(c) {
    ...
    if (this.showCollisionVectors) {
      ...
      if (testVecs.some((el) => el)) {
        testVecs.forEach(
          (vec) => vec.draw(c, new Point(this.pos.x, this.pos.y), "#0000ff")
        );
      }
    }
  ...
  scale(value, t = 0) {
    ...
    return transitionValues(
      () => {
        ...
        __privateMethod(this, _updateDimentions, updateDimentions_fn).call(this);
      },
      () => {
...
_updateDimentions = new WeakSet();
updateDimentions_fn = function() {
...
render_fn = function(c) {
  setTimeout(() => {
    ...
    __privateMethod(this, _render, render_fn).call(this, c);
  }, 1e3 / fps);
};
